...
with open( '/dcs04/hansen/data/ywang/ST/DLPFC/PASTE_out_dist005/rd_induced_2_3_s1.pkl', 'rb') as inp:
              rd_s1 = pickle.load(inp)


with open( '/dcs04/hansen/data/ywang/ST/DLPFC/PASTE_out_dist005/rd_induced_2_3_s2.pkl', 'rb') as inp:
...
####################################################
## 0240 training complete, converged.
