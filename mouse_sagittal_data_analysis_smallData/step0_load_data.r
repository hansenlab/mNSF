...
kp_spots_1=order(X[,1])[1:1000]
kp_spots_=order(X[kp_spots_1,2])[1:600]

X=X[kp_spots_1[kp_spots_],]
Y=Y[kp_spots_1[kp_spots_],]




write.csv(Y,row.names = F,#col.names = F,
          file=paste0("Y_sample",1,"_smallData.csv"))

write.csv(X,row.names = F,#col.names = F,
          file=paste0("X_sample",1,"_smallData.csv"))
...
write.csv(Y,row.names = F,#col.names = F,
          file=paste0("Y_sample",2,"_smallData.csv"))

write.csv(X,row.names = F,#col.names = F,
          file=paste0("X_sample",2,"_smallData.csv"))
