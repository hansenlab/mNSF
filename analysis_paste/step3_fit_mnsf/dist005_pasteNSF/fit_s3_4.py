...
with open( '/dcs04/hansen/data/ywang/ST/DLPFC/PASTE_out_dist005/rd_induced_3_4_s1.pkl', 'rb') as inp:
              rd_s1 = pickle.load(inp)


with open( '/dcs04/hansen/data/ywang/ST/DLPFC/PASTE_out_dist005/rd_induced_3_4_s2.pkl', 'rb') as inp:
              rd_s2 = pickle.load(inp)


X1=pd.read_csv(path.join('/dcs04/hansen/data/ywang/ST/DLPFC/processed_Data_dist005/X_kp_' + sample_pair + '_filterDist005_s1_corrected.csv'))

n1 = X1.shape[0]

for kitem in range(0,len(rd_s2)):
	rd_s2[kitem] = rd_s2[kitem]+ n1
...
D["Z"] = np.concatenate((D["X"][rd_s1,], D["X"][rd_s2,]), axis=0) 
...
#'/dcs04/hansen/data/ywang/ST/DLPFC/PASTE_out_dist005_scMean/models/L3/nb_sz-constant_ss3_s4__qsub/NPF_MaternThreeHalves_M8431'
